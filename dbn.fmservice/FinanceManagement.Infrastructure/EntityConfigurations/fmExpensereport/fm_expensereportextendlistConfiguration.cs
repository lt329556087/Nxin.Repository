...
{
    public class fm_expensereportextendlistConfiguration : IEntityTypeConfiguration<fm_expensereportextendlist>
    {
        public void Configure(EntityTypeBuilder<fm_expensereportextendlist> entity)
        {
