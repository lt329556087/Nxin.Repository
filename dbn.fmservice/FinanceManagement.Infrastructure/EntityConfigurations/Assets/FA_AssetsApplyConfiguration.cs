...
{
    public class FA_AssetsApplyConfiguration : IEntityTypeConfiguration<FA_AssetsApply>
    {
        public void Configure(EntityTypeBuilder<FA_AssetsApply> entity)
        {
    ...
    public class FA_AssetsApplyDetailConfiguration : IEntityTypeConfiguration<FA_AssetsApplyDetail>
    {
        public void Configure(EntityTypeBuilder<FA_AssetsApplyDetail> entity)
        {
