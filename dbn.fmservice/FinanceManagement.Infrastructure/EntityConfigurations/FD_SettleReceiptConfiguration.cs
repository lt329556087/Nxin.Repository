...
{
    public class FD_SettleReceiptConfiguration : IEntityTypeConfiguration<FD_SettleReceipt>
    {
        public void Configure(EntityTypeBuilder<FD_SettleReceipt> entity)
        {
            entity.HasKey(e => e.NumericalOrder)
                .HasName("PRIMARY");

            entity.HasComment("凭证表头");
