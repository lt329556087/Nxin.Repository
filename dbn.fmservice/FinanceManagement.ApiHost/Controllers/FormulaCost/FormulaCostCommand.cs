...
namespace FinanceManagement.ApiHost.Controllers.PerformanceIncome
{
    ...
    public class FormulaCostAddCommand : FormulaCostCommand, IRequest<Result>
    {

    }

    public class FormulaCostDeleteCommand : FormulaCostCommand, IRequest<Result>
    {

    }

    public class FormulaCostModifyCommand : FormulaCostCommand, IRequest<Result>
    {
    }
    public class FormulaCostCopyCommand : FormulaCostCommand, IRequest<Result>
    {
        public List<string> EnterpriseIds { get; set; }
    }
    public class FormulaCostCommand 
    {
        ...
        public List<FormulaCostCommand> List { get; set; } = new List<FormulaCostCommand>();
    }
    public class FormulaCostSearch
    {
