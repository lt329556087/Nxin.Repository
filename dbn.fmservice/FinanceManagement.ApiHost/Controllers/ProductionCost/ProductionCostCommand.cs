...
namespace FinanceManagement.ApiHost.Controllers.PerformanceIncome
{
    ...
    public class ProductionCostAddCommand : ProductionCostCommand, IRequest<Result>
    {

    }

    public class ProductionCostDeleteCommand : ProductionCostCommand, IRequest<Result>
    {

    }

    public class ProductionCostModifyCommand : ProductionCostCommand, IRequest<Result>
    {
    }
    public class ProductionCostCopyCommand : ProductionCostCommand, IRequest<Result>
    {
        public List<string> EnterpriseIds { get; set; }
    }
    public class ProductionCostCommand 
    {
        ...
        public List<ProductionCostCommand> List { get; set; } = new List<ProductionCostCommand>();
    }
    public class ProductionCostSearch
    {
