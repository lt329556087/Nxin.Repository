...
namespace FinanceManagement.ApiHost.Controllers.PerformanceIncome
{
    ...
    [ApiController]
    public class ProfitBorController : ControllerBase
    {
        ProfitBorODataProvider _prodiver;
        private QlwCrossDbContext _dbContext;
        private IIdentityService _identityService;
        FMBaseCommon _fmBaseCommon;

        public ProfitBorController(ProfitBorODataProvider prodiver, FMBaseCommon fmBaseCommon,IIdentityService identityService)
        {
            _prodiver = prodiver;
        ...
        [HttpPost]
        [Route("GetProfitData")]
        public dynamic GetProfitData(ProfitSearch model)
        {
            ...
            return _prodiver.GetProfit(model);
        }
        #endregion 
