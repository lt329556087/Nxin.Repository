...
namespace FinanceManagement.Common.MakeVoucherCommon
{
    public class CheckenCostSummaryCommon : MakeVoucherBase
    {
        ...
        private List<CheckenSummaryResultData> GetCheckenSummaryDataList(FM_CarryForwardVoucherODataEntity model, FM_CarryForwardVoucherInterfaceSearchCommand request, FM_CarryForwardVoucherDetailODataEntity item, FD_SettleReceipt domain, bool isBreak, List<RptSearchModel> rpts)
        {
            try
            {
                #region 构造接口参数
        ...
        public Dictionary<string, string> GetDict()
        {
            ...
            value.Add("1911081429200000501", "InHenCost3");
            value.Add("1911081429200000502", "OutCostPig3");
            value.Add("1911081429200000503", "OutCostPig4");
            value.Add("1911081429200000504", "OutCostPig5");
            value.Add("1911081429200000505", "InCostPig3");
            value.Add("1911081429200000506", "InHenCost7");
            value.Add("1911081429200000507", "InHenCost4");
            value.Add("1911081429200000508", "OutCostPig3_1");
            value.Add("1911081429200000509", "OutCostPig4_1");
            value.Add("1911081429200000510", "OutCostPig5_1");
            value.Add("1911081429200000511", "InCostPig3_1");
            value.Add("1911081429200000512", "InHenCost4_1");
            value.Add("1911081429200000513", "OutCostChicken21");
            value.Add("1911081429200000514", "OutCostChicken31");
            value.Add("1911081429200000515", "OutCostChicken41");
            value.Add("1911081429200000516", "OutCostChicken51");
            value.Add("1911081429200000517", "InHenCost81");
            value.Add("1911081429200000518", "OutHenCost31");
            value.Add("1911081429200000519", "OutHenCost32");
            value.Add("1911081429200000520", "OutHenCost33");
            value.Add("1911081429200000521", "OutHenCost34");
            value.Add("1911081429200000522", "OutHenCost35");
            value.Add("1911081429200000523", "OutHenCost3");
            value.Add("1911081429200000524", "OutCostChicken1");
            value.Add("1911081429200000525", "OutCostChicken2");
            value.Add("1911081429200000526", "OutCostChicken3");
            value.Add("1911081429200000527", "OutCostChicken4");
            value.Add("1911081429200000528", "OutCostChicken5");
            value.Add("1911081429200000529", "InHenCost5");
            value.Add("1911081429200000530", "InHenCost6");
            value.Add("1911081429200000531", "OutHenCost81");
            value.Add("1911081429200000532", "OutHenCost82");
            value.Add("1911081429200000533", "OutHenCost83");
            value.Add("1911081429200000534", "OutHenCost84");
            value.Add("1911081429200000535", "OutHenCost85");
            value.Add("1911081429200000536", "OutHenCost8");
            value.Add("1911081429200000537", "OutHenCost113_1");
            value.Add("1911081429200000538", "OutHenCost114_1");
            value.Add("1911081429200000539", "OutHenCost115_1");
            value.Add("1911081429200000540", "InHenCost116_1");
            value.Add("1911081429200000541", "InHenCostSum110_1");
            value.Add("1911081429200000542", "SetStockCost1");
            value.Add("1911081429200000543", "SetStockCost2");
            value.Add("1911081429200000544", "SetStockCost3");
            value.Add("1911081429200000545", "SetStockCost4");
            value.Add("1911081429200000546", "SetStockCost5");
            value.Add("1911081429200000547", "SetStockCost");
            value.Add("1911081429200000548", "SetStockCost");
            value.Add("1911081429200000549", "OutCostPig3_2");
            value.Add("1911081429200000550", "OutCostPig4_2");
            value.Add("1911081429200000551", "OutCostPig5_2");
            value.Add("1911081429200000552", "InCostPig3_2");
            value.Add("1911081429200000553", "InHenCost7");
            value.Add("1911081429200000554", "InHenCost4_2");
            value.Add("1911081429200000555", "InHenCost118");
            value.Add("1911081429200000556", "originalValueReduce");
            value.Add("1911081429200000557", "depreciationAccumulatedReduce");
            value.Add("1911081429200000558", "originalValueSalesReduce");
            value.Add("1911081429200000559", "depreciationAccumulatedSalesReduce");
            return value;
        }
    }
