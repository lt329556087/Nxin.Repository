...
namespace FinanceManagement.Common.MakeVoucherCommon
{
    ...
    public class DiscountSummaryRequest
    {
        ...
        /// 
        /// </summary>
        public string IsCateEnterpriseHiddenInput { get; set; }
        /// <summary>
        /// 
        /// </summary>
    ...
    public class DiscountSummaryResult:EntitySubClass
    {
        /// <summary>
        /// 北大农集团
        /// </summary>
        ...
        /// 
        /// </summary>
        public decimal GlitAmount { get; set; }
        /// <summary>
        /// 
        /// </summary>
        public decimal SubTotal { get; set; }
    }
    public class FM_CarryForwardVoucherInterfaceSearchCommand
    {
    ...
    public class MakeVoucherModel: FM_CarryForwardVoucherInterfaceSearchCommand
    {
        /// <summary>
        /// 多个凭证方案生成一张凭证
        /// </summary>
    ...
    public class EnterprisePeriodSearch
    {
        public string EnterpriseID { get; set; }
        public int Year { get; set; }
        public int Month { get; set; }
    }
    public class EnterprisePeriod
    {
        public string EnterpriseID { get; set; }
        public int Year { get; set; }
        public int Month { get; set; }
